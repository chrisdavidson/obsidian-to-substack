...
| 16 | Footnote | The `[^1]` marker in "Closing" appears as a small superscript, and the footnote text (starting "Guidelines for the Construction…") appears at the bottom of the post where you can correlate it with the marker |✅ 2026-08-08 — pasted fine, superscript and text both showed. Closes ACPT-01 and the v1.0 audit's only gap |
